...
describe("Colecciones en JS: Array", () => {
    it("Pueden crearse usando [ ]", () => {
        ...
        let a = ['apple','orange','banana','pineapple','pear','grape','mango'];
    ...
    it("Pueden crearse usando new Array", () => {
       ...
       let a = new Array('apple','orange','banana','pineapple','pear','grape','mango');
        expect(Array.isArray(a)).to.be.true;
    })
    it("Pueden estar vacíos o contener elementos", () => {
        ...
        let emptyArray = [];
        let nonEmptyArray = ['apple','orange','banana','pineapple','pear','grape','mango'];
...
describe("Operaciones iterables", () => {
    ...
    it("Buscando el planeta con Array.includes", () => {
        ...
        if(knownExoplanets.includes('TOI-1634 b')){
            return true;
        }else{
            return false;
        }
    ...
    it("filtrando planetas", () => {
     ...
     let  result =    knownExoplanets.filter((e) => e.endsWith("c"));
